cd c:\c_portab\01_rb\_desa_documents\rb_desarrollo\pgmng\go\src\bar8tl\p\
md idoc2txt
cd idoc2txt
...
copy c:\c_portab\01_rb\_rbprojects\go-idoc2txt\ridmitm.go   .
copy c:\c_portab\01_rb\_rbprojects\go-idoc2txt\ridsgrp.go   .
copy c:\c_portab\01_rb\_rbprojects\go-idoc2txt\ridssgm.go   .
copy c:\c_portab\01_rb\_rbprojects\go-idoc2txt\settings.go  .
copy c:\c_portab\01_rb\_rbprojects\go-idoc2txt\unfold.go    .
go install
pause
